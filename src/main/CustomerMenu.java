...
//		} while (regCustomerComplaints.isEmpty());
		...
		Customer customer = new Customer(customerIDvessel, regCustomerName, regCustomerPhone, regCustomerLP, regCustomerVP, null);
		
		String insertCustomerQuery = String.format("INSERT INTO customer VALUES('%s', '%s', '%s', '%s', '%s')", 
...
//				System.out.println(idBarang);
		...
		String queryInsertUC_Transaction = String.format("INSERT INTO UC_Transaction "
				+ "VALUES('%s', '%s', '%s', '%s')", 
				transactionID, transactionDate, status, keluhan);
